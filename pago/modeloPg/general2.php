...
<body>
    Hola usuario ' . $usuario[0]['username'] . 'con el numero de cedula '.$usuario[0]['numeroCED'].', correo '.$usuario[0]['email'].' 
    y numero celular '.$usuario[0]['numeroTEl'].' </br>
    ...
    Su conductor es ' . $ruta[0]['nombre_emp'] . ' ' . $ruta[0]['apellido'] . ' y con la cedula '.$ruta[0]['cedula'].'
    <p>Descripcion :</p>
