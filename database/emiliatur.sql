...
--
-- Host: localhost    Database: emiliatur-sa
-- ------------------------------------------------------
...
CREATE TABLE `boleto` (
  ...
  `num_boleto` int(10) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`num_boleto`),
  KEY `usuario` (`id_usuario`),
  KEY `id_destino` (`id_destino`) USING BTREE,
  CONSTRAINT `boleto_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `boleto_ibfk_3` FOREIGN KEY (`id_destino`) REFERENCES `destino` (`id_destino`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4789 DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
...
INSERT INTO `boleto` VALUES (23,1,135,'2020-11-07',3,4725),(23,1,135,'2020-11-07',4,4726),(23,1,135,'2020-11-07',5,4727),(23,1,135,'2020-11-07',6,4728),(23,1,135,'2020-11-07',7,4729),(23,1,135,'2020-11-07',8,4730),(21,18,150,'2020-11-07',0,4731),(21,18,150,'2020-11-07',1,4732),(21,18,150,'2020-11-07',2,4733),(21,18,150,'2020-11-07',3,4734),(24,17,15,'2020-11-19',0,4735),(24,1,135,'2020-11-21',0,4736),(24,1,135,'2020-11-21',1,4737),(24,1,135,'2020-11-21',2,4738),(24,1,135,'2020-11-21',3,4739),(24,1,135,'2020-11-21',4,4740),(24,1,135,'2020-11-21',5,4741),(24,1,135,'2020-11-21',6,4742),(24,1,135,'2020-11-21',7,4743),(24,1,135,'2020-11-21',8,4744),(24,8,15,'2020-11-21',0,4745),(24,18,90,'2020-11-22',0,4746),(24,18,90,'2020-11-22',1,4747),(24,18,90,'2020-11-22',2,4748),(24,18,90,'2020-11-22',3,4749),(24,18,90,'2020-11-22',4,4750),(24,18,90,'2020-11-22',5,4751),(24,13,105,'2020-11-22',0,4752),(24,13,105,'2020-11-22',1,4753),(24,13,105,'2020-11-22',2,4754),(24,13,105,'2020-11-22',3,4755),(24,13,105,'2020-11-22',4,4756),(24,13,105,'2020-11-22',5,4757),(24,13,105,'2020-11-22',6,4758),(24,17,225,'2020-11-22',0,4759),(24,17,225,'2020-11-22',1,4760),(24,17,225,'2020-11-22',2,4761),(24,17,225,'2020-11-22',3,4762),(24,17,225,'2020-11-22',4,4763),(24,17,225,'2020-11-22',5,4764),(24,17,225,'2020-11-22',6,4765),(24,17,225,'2020-11-22',7,4766),(24,17,225,'2020-11-22',8,4767),(24,17,225,'2020-11-22',9,4768),(24,17,225,'2020-11-22',10,4769),(24,17,225,'2020-11-22',11,4770),(24,17,225,'2020-11-22',12,4771),(24,17,225,'2020-11-22',13,4772),(24,17,225,'2020-11-22',14,4773),(24,17,225,'2020-11-22',0,4774),(24,17,225,'2020-11-22',1,4775),(24,17,225,'2020-11-22',2,4776),(24,17,225,'2020-11-22',3,4777),(24,17,225,'2020-11-22',4,4778),(24,17,225,'2020-11-22',5,4779),(24,17,225,'2020-11-22',6,4780),(24,17,225,'2020-11-22',7,4781),(24,17,225,'2020-11-22',8,4782),(24,17,225,'2020-11-22',9,4783),(24,17,225,'2020-11-22',10,4784),(24,17,225,'2020-11-22',11,4785),(24,17,225,'2020-11-22',12,4786),(24,17,225,'2020-11-22',13,4787),(24,17,225,'2020-11-22',14,4788);
...
CREATE TABLE `buses` (
  ...
  `numeroVehiculo` int(10) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`matricula`),
  UNIQUE KEY `numeroVehiculo` (`numeroVehiculo`)
...
INSERT INTO `buses` VALUES ('ESP-123',45,10,40,'activo',1),('gol-123',0,25,40,'activo',8),('gol-sls',0,25,40,'activo',9),('hps-453',30,25,40,'inactivo',2),('jps-546',30,40,40,'inactivo',3),('kls-325',25,40,40,'activo',5),('ksj-951',50,20,40,'activo',7),('lsd-753',30,25,40,'activo',6),('lsp-785',30,25,40,'activo',4),('mol-451',0,12,40,'activo',11);
...
CREATE TABLE `carrito` (
  ...
  KEY `destino` (`destino`) USING BTREE,
  KEY `id_usuario` (`id_usuario`),
  KEY `id_ruta` (`id_ruta`),
  CONSTRAINT `carrito_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `carrito_ibfk_2` FOREIGN KEY (`id_ruta`) REFERENCES `rutas` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `r` FOREIGN KEY (`destino`) REFERENCES `destino` (`id_destino`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `compras` (
  ...
  KEY `ruta_id` (`ruta_id`),
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`id_destino`) REFERENCES `destino` (`id_destino`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `compras_ibfk_3` FOREIGN KEY (`ruta_id`) REFERENCES `rutas` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `compras` VALUES (26,25,1,4,150,'credito',59,'','pendiente'),(27,26,2,1,15,'Credito',60,'','pendiente'),(28,24,1,4,60,'Credito',65,'','pendiente'),(29,24,2,9,135,'Debito',66,'','pendiente'),(32,24,2,4,60,'Credito',66,'2021-04-14','pendiente');
...
CREATE TABLE `correos` (
  ...
  `fecha` date NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `correos` VALUES (1,'compra de voletos','destino X manera X ','visto','2020-11-18'),(2,'compra de voletos','destino guallaquil','visto','2020-11-24'),(3,'compra de voletos','x destino','visto','2020-11-24'),(4,'compra de voletos','x destinos','visto','2020-11-03'),(5,'compra de voletos','el usuario  a comprado voletos para el destino: Ambato','visto','2020-11-03'),(6,'compra de voletos','el usuario  a comprado voletos para el destino: Ambato','visto','2020-11-03'),(7,'compra de voletos','el usuario admin a comprado voletos para el destino: Ambato','visto','2020-11-03'),(8,'compra de voletos','el usuario jonathan a comprado voletos para el destino: Quito','visto','2020-12-11'),(9,'compra de voletos','el usuario jonathan a comprado voletos para el destino: Quito','visto','2020-12-11'),(10,'compra de voletos','el usuario jonathan a comprado voletos para el destino: Quito','visto','2020-12-11'),(11,'compra de voletos','el usuario admin a comprado voletos para el destino: Guallaquil','visto','2021-04-12'),(12,'compra de voletos','el usuario admin a comprado voletos para el destino: Quito','visto','2021-04-12'),(13,'compra de voletos','el usuario admin a comprado voletos para el destino: Guallaquil','visto','2021-04-13'),(14,'compra de voletos','el usuario admin a comprado voletos para el destino: Guallaquil','visto','2021-04-13'),(15,'compra de voletos','el usuario admin a comprado voletos para el destino: Quito','visto','2021-04-13'),(16,'compra de voletos','el usuario admin a comprado voletos para el destino: Quito','visto','2021-04-13'),(17,'compra de voletos','el usuario admin a comprado voletos para el destino: Quito','visto','2021-04-13');
...
INSERT INTO `empleado` VALUES (12356543,'Olatz','Fuentes',35,'Masculino','975465762'),(123245324,'juan','diaz',25,'hombre','9142324'),(245653535,'Andrea','Prat',25,'femenino','945454757'),(564545655,'Pablo','Caro',25,'masculino','942572362'),(1207207752,'jonathan','vera',52,'Femenino','099714243558'),(1207207755,'manuel','torrez',35,'masculino','997424354'),(1207564565,'Esther','Pedraza',45,'femenino','974432455'),(1235454324,'vicente','torrez',42,'hombre','97542435');
...
CREATE TABLE `rutas` (
  ...
  KEY `id_destino` (`id_destino`),
  KEY `id_buses` (`id_buses`),
  CONSTRAINT `rutas_ibfk_1` FOREIGN KEY (`id_emple`) REFERENCES `empleado` (`cedula`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `rutas_ibfk_2` FOREIGN KEY (`id_destino`) REFERENCES `destino` (`id_destino`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `rutas_ibfk_3` FOREIGN KEY (`id_buses`) REFERENCES `buses` (`matricula`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `rutas` VALUES (42,12356543,1,'ESP-123','2020-10-28','03:42'),(43,12356543,2,'hps-453','2020-10-30','21:47'),(44,123245324,3,'ESP-123','2020-10-30','23:48'),(45,245653535,4,'jps-546','2020-10-31','23:49'),(46,123245324,5,'ESP-123','2020-10-31','23:50'),(47,564545655,6,'lsd-753','2020-11-01','23:50'),(48,1207564565,7,'hps-453','2020-10-31','19:51'),(49,1235454324,9,'kls-325','2020-11-03','15:51'),(50,564545655,10,'lsp-785','2020-11-02','23:51'),(51,1235454324,11,'lsd-753','2020-11-04','14:52'),(52,12356543,12,'ESP-123','2020-11-07','23:52'),(53,245653535,14,'lsp-785','2020-11-03','23:53'),(54,1235454324,13,'lsd-753','2020-10-31','22:54'),(55,12356543,15,'lsd-753','2020-11-02','23:55'),(56,123245324,16,'hps-453','2020-11-07','23:56'),(57,564545655,8,'kls-325','2020-10-31','23:56'),(58,1207564565,17,'lsd-753','2020-10-30','23:57'),(59,123245324,18,'lsp-785','2020-11-26','18:01'),(60,12356543,2,'ESP-123','2020-12-12','12:21'),(61,12356543,1,'ESP-123','2121-01-15','19:49'),(63,564545655,5,'jps-546','2021-01-15','22:53'),(65,12356543,1,'hps-453','2021-04-18','23:35'),(66,12356543,2,'jps-546','2021-04-19','00:36');
...
CREATE TABLE `usuario` (
  ...
  PRIMARY KEY (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf32 COLLATE=utf32_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (8,'este','as@hd.com','741'),(16,'date','d@dm.com','1234567'),(19,'N@omy','adf@gm.com','$2y$10$vXnC4uR0wd1gJ.FqarA/MuXzV.4m.WekBdjsVpY7P6b'),(20,'jontahan','l@gm.com','$2y$10$VeHjIj3dKBfk46AueZCHq.J.0GcB5P/za.w5LD.nOuT'),(21,'coello','g@mai.com','$2y$10$I52109L.Y135.0hWDv6lTePzFEj.CXdwZgcubdGLgKz'),(23,'n@omy','n@omy.com','$2y$10$M6u3bK5CPaTSbYXCyh3aYOkA729fEg0g1SGg.Zd8WcHUbzS25q.82'),(24,'admin','admin@gmail.com','$2y$10$HPL5aX3NwmmgFju2M5WKregjXYXqt8Y2u4Bf1ic7u8qasSTCacjqi'),(25,'lsp12','asd2@das.cop','$2y$10$yjhzBvgMgdPmEErvRbYuxOVSPXmTr4Maw4sboBzAAwpcYvB.lX3FW'),(26,'jonathan','jonathankenny852@gmail.com','$2y$10$lMsxiCmEvYPDJKz6psswuOHLIz4yFAVm0VxKdptijy4./yvrIBq7O');
...
-- Dump completed on 2021-04-13 19:33:04
