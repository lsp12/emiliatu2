...
<div>
  <h2> Ganancias totales <?php if($Ganancias[0]['total']!=null){echo $Ganancias[0]['total'];}else{echo "0";}?> cantidad de voletos vendidos <?php if($Ganancias[0]['cantidad']!=null){echo $Ganancias[0]['cantidad'];}else{echo "0";}?> </h2>
